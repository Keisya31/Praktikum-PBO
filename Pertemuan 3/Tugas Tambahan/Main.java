 ...
 * Lab:B2
 * File: Tiket.java
 * Deskripsi: Program Main restoran
 */
...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            if(menu == null){
                throw new MenuTidakTersediaException("Menu tidak tersedia. Mohon coba lagi");
            }
            ...
            if(jumlahPesanan > menu.getStok()){
                throw new JumlahPesananMelebihiStokException("Jumlah pesanan anda melebihi stok yang tersedia");
            }

            // Melakukan pemesanan
            Pesanan pesanan = new Pesanan(menu, jumlahPesanan);
            menu.kurangiStok(jumlahPesanan);
            //System.out.println( "sisa stok " + menu.getStok());
